  ...
  describe('Class', () => {
    ...
    describe('.asAddress', () => {
      it('returns an address from a cid', () => {
        address = Address.asAddress({ cid: CID.parse(hash) })
      ...
      it('throws if unable and forced to coerce', () => {
        assert.throws(() => Address.asAddress(undefined, true))
        assert.throws(() => Address.asAddress('', true))
        assert.throws(() => Address.asAddress({ cid: hash }, true))
      })
    })
  ...
  describe('Instance', () => {
    ...
    describe('.equals', () => {
      ...
      it('returns false if the addresses are different', () => {
        const _hash = 'bafyreib2caa6txg46uhpt43bgfnfk3wzfdbz4n2frn2brbrjtjuambgd6i'
